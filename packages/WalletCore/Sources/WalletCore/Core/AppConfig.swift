...
enum AppConfig {
    static let label = "network.lux.wallet"
    static let backupSalt = "unstoppable"

    static let companyName = "Lux Industries"
    static let reportEmail = "support@lux.network"
    static let companyWebPageLink = "https://lux.network"
    static let appWebPageLink = "https://lux.network/wallet"
    static let analyticsLink = "https://lux.network/wallet/analytics"
    static let privacyPolicyLink = "https://lux.network/privacy-policy"
    ...
    static let appGitHubAccount = "luxwallet"
    static let appGitHubRepository = "unstoppable-wallet-ios"
    static let appTwitterAccount = "luxdefi"
    static let appTelegramAccount = "luxdefi"
